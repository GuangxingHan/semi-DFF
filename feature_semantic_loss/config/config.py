...
config.network.with_pretrained_flow = False
config.network.pretrained_flow = ''
config.network.pretrained_flow_epoch = 0
...
config.TRAIN.lambda_rcnn = 1
config.TRAIN.temperature = 1
config.TRAIN.cls_weight = 1
config.TRAIN.lr = 0
